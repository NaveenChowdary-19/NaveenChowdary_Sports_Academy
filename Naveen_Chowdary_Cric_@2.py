        ...
        for i in range(5):
            ...
            for squad in range(0, 11):
                ...
                if self.Total_Balls <= 120:
                    ...
                    Match_Dictionary_Mumbai_Batting = {'Batsman': Mumbai_Indians_Squad[squad], 'Wicket Type': type, 'Runs': self.Runs,
                                        'Balls': self.Balls, 'Sixes': self.Sixes, 'Strike Rate': self.Strike_Rate}
            ...
            for squad in range(6, 11):
                ...
                Match_Dictionary_Team_II_Bowling = {'Bowler':Team_II_Squad[squad] , 'Overs':self.Overs , 'Runs_Given':List[i] , 'Wickets Taken':List_wick[i] , 'Economy':self.Economy}
