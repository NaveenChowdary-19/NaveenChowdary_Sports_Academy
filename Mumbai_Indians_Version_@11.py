...
Stats_Of_Mumbai = {player :{ 'Runs':0 , 'Balls':0 , 'Sixes':0 } for player in Mumbai_Indians_Squad}
print(Stats_Of_Mumbai)

Stats_Of_Team_II = {player :{ 'Runs':0 , 'Balls':0 , 'Sixes':0 } for player in Team_II_Squad}
...
print("{:<25} {:<10} {}".format( " Batsman " ," " , " Runs ") , end = "\n\n")
