...
class Cricketer:
    ...
    def Series(self):
        ...
        for i in range(5):
            ...
            List_Overs = [self.Bowler_1_Overs , self.Bowler_2_Overs , self.Bowler_3_Overs ,self.Bowler_4_Overs , self.Bowler_5_Overs, self.Bowler_6_Overs]
            # print(List)
            ...
            List_Overs = [self.Bowler_1_Overs , self.Bowler_2_Overs , self.Bowler_3_Overs , self.Bowler_4_Overs , self.Bowler_5_Overs
                           , self.Bowler_6_Overs]
            # print(List)
