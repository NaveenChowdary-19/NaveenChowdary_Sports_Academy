...
class Cricketer:
    ...
    def Series(self):
        ...
        for i in range(5):
            ...
            for squad in range(0, 11):
                ...
                wicket_type = ["Caught & Bowled", "Bowled", "Hit Wicket", "Run Out", " Caught", "Stumped"]

                caught_or_bowled_by = random.choice(Team_II_Squad)

                wicket_type_given = random.choice(wicket_type) + "    By    " + caught_or_bowled_by


                if self.Total_Balls <= 120:
                    print("{:<5}{:<25} {:<9} {:<43} {:<20} {:<10} {:<10} {:<10} {}".format(" ", Mumbai_Indians_Squad[squad]," "  , wicket_type_given ,  " " ,self.Runs,self.Balls, self.Sixes, self.Strike_Rate), end="\n\n")
    ...
    #===================================================================================================================
            ...
            for squad in range(0, 11):
                ...
                if self.Total_Balls <= 120:
                    print("{:<5}{:<25} {:<9} {:<43} {:<20} {:<10} {:<10} {:<10} {}".format(" ", Team_II_Squad[squad]," " , wicket_type_given , " " ,  self.Runs,self.Balls, self.Sixes, self.Strike_Rate), end="\n\n")
                    self.Total_Runs += self.Runs
                    self.Total_Balls += self.Balls
                    self.Total_Sixes += self.Sixes
...
print("{:>10} {} Playing XI are :".format(" " , Teams[0]) + "{:>70}".format(" ") + "   {} Playing XI are :".format(Teams[1]))
